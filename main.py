...
with open('output.txt', 'a+') as file_out:
    print(lc.TEXT_5_80.format(aivos, aivos * 38.95), file=file_out)
    print(lc.TEXT_5_92.format(aidevvt, aidevvt * 40.35), file=file_out)
    print(lc.TEXT_5_95.format(aidevpat, aidevpat * 42.55), file=file_out)
    print(lc.TEXT_5_98.format(aidevvos, aidevvos * 49.2), file=file_out)
    print(lc.TEXT_6.format(nezapravilsa, nezapravilsa * 44.8625), file=file_out)
    print(lc.TEXT_7.format(aivos * 38.95 + aidevvt * 40.35 + aidevpat * 42.55 + aidevvos * 49.2), file=file_out)
